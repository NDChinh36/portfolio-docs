...
### API 01 — GET /specialties — List Available Specialties
...
### API 02 — GET /doctors — List Doctors by Specialty/Date
...
### API 03 — GET /slots — Available Slots (Real-time)
...
### API 04 — POST /appointments — Create Appointment
...
### API 05 — PATCH /appointments/{id}/confirm — Confirm Appointment (Manual)
...
### API 06 — PATCH /appointments/{id}/cancel — Cancel Appointment
...
### API 07 — PATCH /appointments/{id}/reschedule — Reschedule Appointment
...
### API 08 — GET /appointments/{id}/qr — Generate QR Check-in Code
...
### API 09 — POST /checkin/validate-qr — Validate QR at Kiosk/Reception
...
### API 10 — POST /checkin/manual — Manual Check-in by Receptionist
...
### API 11 — POST /his/register — Create HIS Registration (Critical)
...
### API 12 — POST /his/retry-sync — Retry Failed HIS Sync
...
### API 13 — GET /queue/number — Get Queue Number Status
...
### API 14 — PATCH /appointments/{id}/status — Update Visit Status
...
### API 15 — POST /notifications/send — Trigger Notification
...
### API 16 — GET /appointments/daily — Reception Daily Appointment List
