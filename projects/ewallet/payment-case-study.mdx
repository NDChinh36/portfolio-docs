...
### Decision 1 — Tách payment_status và reconciliation_status thành 2 fields riêng biệt
...
### Decision 2 — Timeout → UNKNOWN (không phải FAILED)
...
### Decision 3 — Bắt buộc idempotency_key cho mọi payment request
...
### Decision 4 — Reconciliation mismatch queue real-time thay vì chỉ batch export cuối ngày
...
### Decision 5 — Biometric = convenience shortcut, PIN = primary auth layer
...
### [Reconciliation Dashboard](/projects/ewallet/reconciliation-dashboard)
...
### [Exception Handling](/projects/ewallet/exception-handling)
