...
`[Insert: Reconciliation dashboard wireframe — 5 KPI cards top row, match rate line chart left, mismatch breakdown stacked bar right, top exceptions list bottom, sticky filter bar]`
