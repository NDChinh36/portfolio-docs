...
- **Audit Trail Bắt buộc** — Mọi hành động manual resolve đều được ghi log với timestamp, user, lý do và trạng thái trước/sau.
