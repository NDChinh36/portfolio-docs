...
description: "Case Study — Business Analyst · Nami Innovation · 2025 – Hiện tại"
icon: "chart-line"
---

<Info>
  **Vai trò:** Business Analyst · **Công ty:** Nami Innovation · **Dự án thực tế**  
  **Thời gian:** 2025 – Hiện tại · **Platform:** Web / Mobile  
...
### Business Rule Register từ đầu

Khi nhận ra futures có hàng chục rules phụ thuộc nhau, tôi đề xuất xây register tập trung thay vì scatter trong nhiều tài liệu. Mỗi rule có: ID, mô tả, formula, danh sách dependency và ví dụ numeric. Engineering dùng để track: *nếu rule này thay đổi, cần update gì tiếp theo*.

### User story trước, technical spec sau

Viết user story cho từng loại trader trước, sau đó mới define business rules cần có để support từng story. Tránh team bị lạc vào technical details trước khi đồng thuận về value thực sự.

### Prototype review trước PRD

Cùng Design review prototype Figma trước khi viết PRD chi tiết. Phần lớn inconsistency giữa UX và business rule được phát hiện ở bước này — không phải sau khi dev đã code.
...
| Rule ID | Điều kiện | Hành vi | Edge Case |
|---|---|---|---|
| BR-LIQ-01 | Margin Ratio ≥ 100% | Đóng toàn bộ position; không cancel được | Insurance fund thiếu → ADL activation |
| BR-WARN-01 | Margin Ratio ≥ 80% | Push notification + in-app alert | Đã warn trong vòng 1h → không warn lại |
| BR-LEV-01 | Leverage ≥ 20x được chọn | Mandatory popup confirmation | Lần 2+ trong cùng session → bỏ qua popup |
| BR-FUND-01 | Cron mỗi 8h; có open position | Long trả short nếu rate dương | Position đóng trước lúc settle → không tính |
