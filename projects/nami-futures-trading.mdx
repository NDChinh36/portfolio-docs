...
<Note>
Phần này ghi rõ các loại artifact BA đã produce trong dự án. Visual minh họa sẽ được bổ sung khi hoàn thiện portfolio.
</Note>
...
*Diagram này được dùng trong PRD review với Design và Engineering trước khi bắt đầu coding. Giúp phát hiện các inconsistency về flow và state trước giai đoạn dev.*
...
`[Bổ sung: Annotated UI — Order Form với annotation cho: (1) Leverage selector + confirmation rule khi ≥20x, (2) Estimated liquidation price real-time, (3) Margin mode toggle Isolated/Cross, (4) Margin required preview trước khi submit, (5) Order type selector và điều kiện kích hoạt từng loại]`

**Artifact 4 — Annotated Position Management Screen**

`[Bổ sung: Annotated UI — Position Management với annotation cho: (1) Unrealized PnL + tần suất update, (2) Margin ratio indicator + trạng thái warning/critical, (3) Add Margin button + điều kiện khả dụng, (4) Close Position button + loại lệnh có thể dùng]`

**Artifact 5 — Liquidation Warning / High Leverage Confirmation Modal**

`[Bổ sung: Annotated UI — Confirmation Modal với annotation cho: (1) Risk message copy, (2) Checkbox "Tôi hiểu rủi ro", (3) Dismiss behavior: 1 lần/session, (4) Leverage threshold trigger, (5) Nút Confirm vs. Cancel behavior]`
